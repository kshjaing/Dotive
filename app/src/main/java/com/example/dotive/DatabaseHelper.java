...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME2 = "Settings"; //Settings 테이블
    ...
    public static final String DarkMode = "darkmode"; //다크모드 bool
    public static final String Language = "language"; //언어
    ...
    public static final String[] ALL_COLUMNS_Settings = {DarkMode, Language};
